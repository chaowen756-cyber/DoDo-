...
from optics.DOE_layer_v4_128 import DOE
from optics.Sensing_layer import Sensing

def Forward_DM_Spiral(input_size=(128, 128,25), DOE_typeA='New',name='Forward_Model'):
    ...
    Out_DOE1a = DOE(Mdoe=MSS, Mesce=Minput,  DOE_type=DOE_typeA, Trai=True)(In_DOE1a)
